...
export const metadata: Metadata = {
  title: "About Us | PrivGPT Studio - Our Mission, Team & AI Vision",
  description:
    "Meet the team behind PrivGPT Studio. Learn about our mission to democratize AI with privacy-first solutions, our core values, and our innovative approach to cloud + local AI models.",
  keywords: [
  ...
  openGraph: {
    title: "About Us | PrivGPT Studio - Our Mission, Team & AI Vision",
    description:
      "Discover PrivGPT Studio's mission to make AI accessible and private. Meet our team and learn about our innovative cloud + local AI solutions.",
    url: "https://privgpt-studio.vercel.app/about",
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "PrivGPT Studio Team and Mission Overview",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "About Us | PrivGPT Studio",
    description:
      "Learn about our mission to democratize AI with privacy-first solutions and our innovative cloud + local AI approach.",
    images: ["https://privgpt-studio.vercel.app/logo.png"],
  },
  alternates: {
    canonical: "https://privgpt-studio.vercel.app/about",
  },
};
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 px-4 text-center">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto">
          ...
          we believe AI should be powerful, accessible, and private. Our mission
          is to provide an intuitive platform that lets users experience the
          best of both cloud-powered and local AI models.
        </p>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                ...
                powerful idea: AI should be accessible, private, and tailored to
                individual needs. We recognized the growing tension between the
                convenience of cloud-based AI and the necessity of data privacy.
              </p>
              <p className="text-muted-foreground">
                Our mission is to democratize AI by giving users the freedom to
                choose between the speed of cloud computing and the security of
                local processing, without compromising on quality or user
                experience.
              </p>
            </div>
